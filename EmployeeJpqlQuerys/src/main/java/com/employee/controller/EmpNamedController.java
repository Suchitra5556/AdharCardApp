...
public class EmpNamedController 
{
	...
	public ResponseEntity<List<Employee>> getByAddressAndNameUnOrder(@PathVariable String address,@PathVariable String name) throws EmployeeNotFoundWithAddressAndNameException
	{
		
		List<Employee> emp =employeeNamedServiceImpl.getByAddressAndNameUnOrder(address, name);
